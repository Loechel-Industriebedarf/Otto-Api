<?php
    ...
    function getOrders($url, $accessToken, $lastDate){		
        ...
        $requestUrl = $url . '/v4/orders?fromOrder=' . urlencode($lastDate) .'&fulfillmentStatus=PROCESSABLE';
        //echo $requestUrl;
        ...
        if(!isset($orders["resources"][0])){
            ...
            foreach($orders["resources"] as &$value){
                foreach($value["positionItems"] as &$item){										
					...
					echo "ProcessDateTime: " . $processDateTime->format('Y-m-d\TH:i:s.000+0000') . PHP_EOL;
